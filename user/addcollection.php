                        ...
                        <div class="Polaris-Layout__AnnotationContent">
                            <div class="Polaris-Card">
                                <div class="Polaris-Card__Section">
                                    ...
                                    <form class="m-t formforparent" id="addcollection_frm" name="register_frm" method="POST"  enctype="multipart/form-data" onsubmit="">
                                         <div class="">
                                        ...
                                        <button type="cancel" name="cancel" class="Polaris-Button Polaris-Button--destructive cancelRequest" data-page="collection" style="float: right; margin-top: 20px; margin-bottom: 10px;">Cancel</button>
                                    </form>
                                </div>
                            </div>
                        </div>
