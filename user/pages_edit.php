                        ...
                        <div class="Polaris-Card">
                            <div class="Polaris-Card__Section">
                                <nav role="navigation" class="product-detail-view">
                                    <a href="pages.php?store=<?php echo $store;?>" class="Polaris-Breadcrumbs__Breadcrumb" data-polaris-unstyled="true">
                                ...
                                <form class="m-t formforparent" id="register_frm" name="register_frm" method="POST"  enctype="multipart/form-data" onsubmit="">
                                    ...
                                    <div class="Polaris-Layout">
                                        <div class="Polaris-Layout__Section">
                                            ...
                                            <input type="hidden" name="for_data" value="<?php echo 'page'; ?>">
...
<script>
    ...
    get_textarea_value(routine_name, store, page_id, "page");
